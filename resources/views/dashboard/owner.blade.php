...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <a href="{{ route('owner.users.index') }}" class="group">
            <x-card class="h-full hover:border-orange-400 hover:shadow-md transition">
                <div class="flex items-start gap-3">
                    <div class="rounded-md bg-indigo-50 p-3 group-hover:bg-indigo-100 transition">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900">User Accounts</h3>
                        <p class="mt-1 text-sm text-slate-600">Manage staff and courier accounts.</p>
                    </div>
                </div>
            </x-card>
        </a>
        <a href="{{ route('devices.index') }}" class="group">
            <x-card class="h-full hover:border-orange-400 hover:shadow-md transition">
                <div class="flex items-start gap-3">
                    <div class="rounded-md bg-rose-50 p-3 group-hover:bg-rose-100 transition">
                        <svg class="w-6 h-6 text-rose-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75a2.25 2.25 0 0 0-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
                        </svg>
                    </div>
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900">Devices</h3>
                        <p class="mt-1 text-sm text-slate-600">Register and bind GPS trackers.</p>
                    </div>
                </div>
            </x-card>
        </a>
